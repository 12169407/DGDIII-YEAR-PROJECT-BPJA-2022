...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        //use a bunch of if statements to generate player movement based on what key they're pressing. 
        //a array of random numbers will generate when the player hits the attack key (left click), and based on the random number an attack animation will play.
